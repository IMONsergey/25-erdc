...
import { projectCategories, selectedProjects } from "../vladivostok-20260922/selectedProjects.js";
import Icon from "../vladivostok-20260922/components/Icon.jsx";
import ProjectDetail from "../components/ProjectDetail.jsx";
import { getAtlasCamera } from "../vladivostok-20260922/atlasCamera.js";
const padded = (n) => String(n).padStart(2, "0");
export default function Projects() {
  const initial = new URLSearchParams(location.search).get("project");
  const [categoryId, setCategoryId] = useState(selectedProjects.find(p=>p.id===initial)?.category || "housing");
  const [projectId, setProjectId] = useState(selectedProjects.some(p=>p.id===initial)?initial:null);
  const [focused, setFocused] = useState(selectedProjects.some(p=>p.id===initial));
    ...
    >
      ...
      >
        ...
        <div className="atlas-bottom">
          <span>Мастер-план развития</span>
          <span>
